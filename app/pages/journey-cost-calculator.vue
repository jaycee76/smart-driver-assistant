...
<template>
  <div class="p-4 md:p-8 max-w-5xl mx-auto">
    <h1 class="text-2xl font-bold mb-6">Journey Cost Calculator</h1>
    ...
    >
      ...
      <span>
        No fill-up history found for your vehicle. Log a fill-up first so the Journey Cost Calculator can calculate fuel costs.
